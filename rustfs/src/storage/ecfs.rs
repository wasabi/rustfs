...
macro_rules! s3_handling_op {
    ($name:literal, $($body:tt)*) => {{
        crate::trace::with_s3_handling_span($name, async move { $($body)* }).await
    }};
}
...
impl S3 for FS {
    ...
    async fn abort_multipart_upload(
        ...
        s3_handling_op!("abort_multipart_upload", {
    ...
    async fn complete_multipart_upload(
        ...
        s3_handling_op!("complete_multipart_upload", {
            let usecase = DefaultMultipartUsecase::from_global();
    ...
    async fn create_multipart_upload(
        ...
        s3_handling_op!("create_multipart_upload", {
            let usecase = DefaultMultipartUsecase::from_global();
    ...
    async fn delete_bucket_cors(&self, req: S3Request<DeleteBucketCorsInput>) -> S3Result<S3Response<DeleteBucketCorsOutput>> {
        s3_handling_op!("delete_bucket_cors", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_bucket_encryption(
        ...
        s3_handling_op!("delete_bucket_encryption", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_bucket_lifecycle(
        ...
        s3_handling_op!("delete_bucket_lifecycle", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_bucket_policy(
        ...
        s3_handling_op!("delete_bucket_policy", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_bucket_replication(
        ...
        s3_handling_op!("delete_bucket_replication", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_bucket_tagging(
        ...
        s3_handling_op!("delete_bucket_tagging", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_bucket_website(
        ...
        s3_handling_op!("delete_bucket_website", {
            let Some(store) = new_object_layer_fn() else {
    ...
    async fn delete_public_access_block(
        ...
        s3_handling_op!("delete_public_access_block", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn delete_object_tagging(
        ...
        s3_handling_op!("delete_object_tagging", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn get_bucket_accelerate_configuration(
        ...
        s3_handling_op!("get_bucket_accelerate_configuration", {
            let Some(store) = new_object_layer_fn() else {
                return Err(s3_error!(InternalError, "Not init"));
            };
    ...
    async fn get_bucket_cors(&self, req: S3Request<GetBucketCorsInput>) -> S3Result<S3Response<GetBucketCorsOutput>> {
        s3_handling_op!("get_bucket_cors", {
    ...
    async fn get_bucket_encryption(
        ...
        s3_handling_op!("get_bucket_encryption", {
    ...
    async fn get_bucket_lifecycle_configuration(
        ...
        s3_handling_op!("get_bucket_lifecycle_configuration", {
    ...
    async fn get_bucket_location(&self, req: S3Request<GetBucketLocationInput>) -> S3Result<S3Response<GetBucketLocationOutput>> {
        s3_handling_op!("get_bucket_location", {
    ...
    async fn get_bucket_notification_configuration(
        ...
        s3_handling_op!("get_bucket_notification_configuration", {
    ...
    async fn get_bucket_policy(&self, req: S3Request<GetBucketPolicyInput>) -> S3Result<S3Response<GetBucketPolicyOutput>> {
        s3_handling_op!("get_bucket_policy", {
    ...
    async fn get_bucket_policy_status(
        ...
        s3_handling_op!("get_bucket_policy_status", {
    ...
    async fn get_bucket_replication(
        ...
        s3_handling_op!("get_bucket_replication", {
    ...
    async fn get_bucket_request_payment(
        ...
        s3_handling_op!("get_bucket_request_payment", {
            let Some(store) = new_object_layer_fn() else {
                return Err(s3_error!(InternalError, "Not init"));
            };
    ...
    async fn get_bucket_tagging(&self, req: S3Request<GetBucketTaggingInput>) -> S3Result<S3Response<GetBucketTaggingOutput>> {
        s3_handling_op!("get_bucket_tagging", {
    ...
    async fn get_public_access_block(
        ...
        s3_handling_op!("get_public_access_block", {
    ...
    async fn get_bucket_versioning(
        ...
        s3_handling_op!("get_bucket_versioning", {
    ...
    async fn get_bucket_website(&self, req: S3Request<GetBucketWebsiteInput>) -> S3Result<S3Response<GetBucketWebsiteOutput>> {
        s3_handling_op!("get_bucket_website", {
            let Some(store) = new_object_layer_fn() else {
                return Err(s3_error!(InternalError, "Not init"));
            };
    ...
    async fn get_object_attributes(
        ...
        s3_handling_op!("get_object_attributes", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn get_object_legal_hold(
        ...
        s3_handling_op!("get_object_legal_hold", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn get_object_lock_configuration(
        ...
        s3_handling_op!("get_object_lock_configuration", {
    ...
    async fn get_object_retention(
        ...
        s3_handling_op!("get_object_retention", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn get_object_tagging(&self, req: S3Request<GetObjectTaggingInput>) -> S3Result<S3Response<GetObjectTaggingOutput>> {
        s3_handling_op!("get_object_tagging", {
    ...
    async fn get_object_torrent(&self, req: S3Request<GetObjectTorrentInput>) -> S3Result<S3Response<GetObjectTorrentOutput>> {
        s3_handling_op!("get_object_torrent", {
    ...
    async fn list_multipart_uploads(
        ...
        s3_handling_op!("list_multipart_uploads", {
    ...
    async fn list_object_versions(
        ...
        s3_handling_op!("list_object_versions", {
    ...
    async fn list_object_versions_m(
        ...
        s3_handling_op!("list_object_versions_m", {
            record_s3_op(S3Operation::ListObjectVersions, &req.input.bucket);
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn list_objects_v2(&self, req: S3Request<ListObjectsV2Input>) -> S3Result<S3Response<ListObjectsV2Output>> {
        s3_handling_op!("list_objects_v2", {
    ...
    async fn list_objects_v2m(&self, req: S3Request<ListObjectsV2Input>) -> S3Result<S3Response<ListObjectsV2MOutput>> {
        s3_handling_op!("list_objects_v2m", {
            record_s3_op(S3Operation::ListObjectsV2, &req.input.bucket);
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_accelerate_configuration(
        ...
        s3_handling_op!("put_bucket_accelerate_configuration", {
            let Some(store) = new_object_layer_fn() else {
                return Err(s3_error!(InternalError, "Not init"));
            };
            store
    ...
    async fn put_bucket_cors(&self, req: S3Request<PutBucketCorsInput>) -> S3Result<S3Response<PutBucketCorsOutput>> {
        s3_handling_op!("put_bucket_cors", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn get_bucket_logging(&self, req: S3Request<GetBucketLoggingInput>) -> S3Result<S3Response<GetBucketLoggingOutput>> {
        s3_handling_op!("get_bucket_logging", {
    ...
    async fn put_bucket_logging(&self, req: S3Request<PutBucketLoggingInput>) -> S3Result<S3Response<PutBucketLoggingOutput>> {
        s3_handling_op!("put_bucket_logging", {
    ...
    async fn put_bucket_encryption(
        ...
        s3_handling_op!("put_bucket_encryption", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_lifecycle_configuration(
        ...
        s3_handling_op!("put_bucket_lifecycle_configuration", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_notification_configuration(
        ...
        s3_handling_op!("put_bucket_notification_configuration", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_policy(&self, req: S3Request<PutBucketPolicyInput>) -> S3Result<S3Response<PutBucketPolicyOutput>> {
        s3_handling_op!("put_bucket_policy", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_replication(
        ...
        s3_handling_op!("put_bucket_replication", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_request_payment(
        ...
        s3_handling_op!("put_bucket_request_payment", {
            let Some(store) = new_object_layer_fn() else {
                return Err(s3_error!(InternalError, "Not init"));
            };
            store
    ...
    async fn put_public_access_block(
        ...
        s3_handling_op!("put_public_access_block", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_tagging(&self, req: S3Request<PutBucketTaggingInput>) -> S3Result<S3Response<PutBucketTaggingOutput>> {
        s3_handling_op!("put_bucket_tagging", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_versioning(
        ...
        s3_handling_op!("put_bucket_versioning", {
            let usecase = DefaultBucketUsecase::from_global();
    ...
    async fn put_bucket_website(&self, req: S3Request<PutBucketWebsiteInput>) -> S3Result<S3Response<PutBucketWebsiteOutput>> {
        s3_handling_op!("put_bucket_website", {
            let Some(store) = new_object_layer_fn() else {
                return Err(s3_error!(InternalError, "Not init"));
            };
            store
    ...
    async fn put_object_legal_hold(
        ...
        s3_handling_op!("put_object_legal_hold", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn put_object_lock_configuration(
        ...
        s3_handling_op!("put_object_lock_configuration", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn put_object_retention(
        ...
        s3_handling_op!("put_object_retention", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn put_object_tagging(&self, req: S3Request<PutObjectTaggingInput>) -> S3Result<S3Response<PutObjectTaggingOutput>> {
        s3_handling_op!("put_object_tagging", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn select_object_content(
        ...
        s3_handling_op!("select_object_content", {
            let usecase = DefaultObjectUsecase::from_global();
    ...
    async fn upload_part_copy(&self, req: S3Request<UploadPartCopyInput>) -> S3Result<S3Response<UploadPartCopyOutput>> {
        s3_handling_op!("upload_part_copy", {
